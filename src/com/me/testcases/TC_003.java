...
public class TC_003 extends BaseClass {
	...
	public void addProduct(Map<String, String> m) throws FileNotFoundException, IOException, InterruptedException, AWTException {
	...
	//	Assert.assertTrue(driver.findElement(By.xpath("//aside[@id='column-right']//a[1][contains(text(),'My Account')]")).isDisplayed(), "Error : Not Succesfully Logged In");
		...
		filewriter.writeIntoFile("TC_004_ProductDetails.txt", "Product Name : "+productName+"\nProduct Details : "+productDetails+"\nProduct Price : "+productPrice+"\n\n");
		
		driver.findElement(By.xpath("//div[contains(@class,'product-layout')][1]//button[contains(@onclick, 'cart.add')]")).click();
		...
		driver.findElement(By.id("input-option208")).sendKeys(m.get("Text"));
		
		Select selectColor = new Select(driver.findElement(By.id("input-option217")));
		selectColor.selectByVisibleText(m.get("Color"));
		
		driver.findElement(By.id("input-option209")).clear();
		driver.findElement(By.id("input-option209")).sendKeys(m.get("TextArea"));
	    ...
	    MyUtilities.upLoadFile(new File(System.getProperty("user.dir")+"/Resources/testdata/"+m.get("ImageFile")));
...
//	    driver.switchTo().alert().accept();
		...
		driver.findElement(By.id("input-option219")).sendKeys(m.get("Date").replaceAll("[^a-zA-Z0-9]", "-"));
		
		driver.findElement(By.id("input-option221")).clear();
		driver.findElement(By.id("input-option221")).sendKeys(m.get("Time"));
		
		driver.findElement(By.id("input-quantity")).clear();
		driver.findElement(By.id("input-quantity")).sendKeys(m.get("Quantity"));
		
		driver.findElement(By.id("input-option220")).clear();
		driver.findElement(By.id("input-option220")).sendKeys(m.get("DateTime"));
		...
		filewriter.writeIntoFile("TC_004_ProductDetails.txt", "Product Name : "+prodName+"\nProduct Price : "+prodPrice+"\n\n");
	...
	//###########################################################################################
		...
		ExcelUtils.writeInExcel(str, "TableData", "Sheet1");
	...
	//###########################################################################################		
		...
		filewriter.writeIntoFile("TC_003_LogoutMsg.txt", completelogoutMsg.toString());
